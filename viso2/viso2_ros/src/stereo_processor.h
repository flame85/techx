...
protected:
    ...
    left_received_(0), right_received_(0), left_info_received_(0), right_info_received_(0), all_received_(0)
  {
...
#if(USE_BIG_IMAGE)
    std::string left_topic = "/big_left_rectified/rgb_rectified";
    std::string left_info_topic = "/big_left_rectified/camera_info";
    std::string right_topic = "/big_right_rectified/rgb_rectified";
    std::string right_info_topic = "/big_right_rectified/camera_info";
#else
    std::string left_topic = "/left_rectified/rgb_rectified";
    std::string left_info_topic = "/left_rectified/camera_info";
    std::string right_topic = "/right_rectified/rgb_rectified";
    std::string right_info_topic = "/right_rectified/camera_info";
#endif
    ...
    // Complain every 10s if the topics appear unsynchronized
    ...
    check_synced_timer_ = nh.createWallTimer(ros::WallDuration(10.0),
