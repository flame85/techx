...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        MainWindowDesign->resize(812, 704);
        QIcon icon;
        ...
        pose_tab = new QWidget();
        pose_tab->setObjectName(QString::fromUtf8("pose_tab"));
        verticalLayout_5 = new QVBoxLayout(pose_tab);
        verticalLayout_5->setObjectName(QString::fromUtf8("verticalLayout_5"));
        groupBox_2 = new QGroupBox(pose_tab);
        groupBox_2->setObjectName(QString::fromUtf8("groupBox_2"));
        gridLayout_2 = new QGridLayout(groupBox_2);
        gridLayout_2->setObjectName(QString::fromUtf8("gridLayout_2"));
        glwidget = new MyGLWidget(groupBox_2);
        glwidget->setObjectName(QString::fromUtf8("glwidget"));

        gridLayout_2->addWidget(glwidget, 0, 0, 1, 1);
